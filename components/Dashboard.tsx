        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-sm border border-gray-700 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold mt-1">{totalAvailableCash.toLocaleString()} <span className="text-lg font-normal text-gray-400">SAR</span></h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-800">{totalMonthlySpend.toLocaleString()} SAR</h3>
            </div>
